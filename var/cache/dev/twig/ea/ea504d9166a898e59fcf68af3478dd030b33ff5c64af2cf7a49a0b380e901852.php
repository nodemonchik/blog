...
class __TwigTemplate_7c4a6acfed8ff4d1fa59dd4563d0cfff3d6c32420a5a1c89e18470791bbde465 extends Template
{
    private $source;
    private $macros = [];
...
{% block title %}test react app{% endblock %}

{% block body %}
    <h1>{{ message }}</h1>
    <div id=\"root\"></div>
{% endblock %}
", "hello/index.html.twig", "/home/johnromanoff/symfirst/templates/hello/index.html.twig");
    }
}
